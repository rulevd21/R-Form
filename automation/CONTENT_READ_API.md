...
> Версия 0.1 сохранена как безопасная реализация только для чтения. Управляемые действия владельца добавлены в `content_control_api_v0_3.gs`; порядок обновления описан в `CONTENT_CONTROL_API.md`.
