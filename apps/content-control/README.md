# R/Form · Управление контентом v0.4.1
...
- три решения: **«Добавить в публикации» / «Сохранить для Weekly» / «Не использовать»**;
...
После обновления backend в разделе «Система» должны отображаться capabilities `event.review`, `event.decision` и `event.media`, а в шапке приложения — `ЕЖЕДНЕВНЫЙ РЕЖИМ · v0.4.1`.
