# R/Form · Управление контентом v0.4.2
...
После обновления backend в разделе «Система» должны отображаться capabilities `event.review`, `event.decision` и `event.media`, а в шапке приложения — `ЕЖЕДНЕВНЫЙ РЕЖИМ · v0.4.2`.
